...
/**
 * El panel interno · todavia sin producto.
 *
 ...
 *
 * Lo que va aqui lo construye M23 · Panel interno.
 */
  ...
  return (
    <main className="mx-auto flex w-full max-w-[42rem] flex-col gap-e4 px-e4 py-e7">
      <header>
        ...
        <h1 className="text-pantalla font-semibold">El panel interno</h1>
        <p className="text-secundario text-naranja">Tu cocina, bajo control.</p>
      </header>

      <Tarjeta>
        <TodaviaNo
          que="El panel interno"
          queHabra="Las cuentas, los planes, el uso y el soporte. Solo para dentro."
          modulo="M23 · Panel interno"
        />
      </Tarjeta>

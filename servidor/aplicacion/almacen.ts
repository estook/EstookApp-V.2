 ...
 * que poder cambiarla. Mientras solo apuntaba quien lleva Almacén, daba igual.
 ...
 */
export async function sembrarElAlmacen(
  contexto: Contexto,
  localId: string,
  ...
  // no se le meten ejemplos por detrás: «Estook no mete nada en tu almacén».

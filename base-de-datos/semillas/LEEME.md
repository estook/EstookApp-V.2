...
| `personas.sql`      | 11 personas, sus membresias, un recorte y unas politicas | El caso de aceptacion de M1                                     |
...
| Vera     | gerente        | Bar Ribera   | 1 · la de las capturas |

Ignacio es el criterio de terminado de M1, sembrado: «un area manager ve
exactamente sus tres locales».

**Vera** es la de las capturas (entrega V): las pruebas que fotografian la
aplicacion en claro y en oscuro entran con ella y ninguna otra lo hace, para que
lo que sale en la foto no lo cambie otra prueba a la vez. Su local no tiene
genero, que es lo que ensenan los vacios.

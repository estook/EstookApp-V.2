 ...
 * proveedores y precios— y quien abre Almacén para ver lo que hay no tiene por
...
export function Almacen({ destino, vista }: { readonly destino: string; readonly vista: string }) {
  ...
  return (
    <>
      ...
      {/*
        ...
        descarga al entrar en Almacén, sino al abrir el primero. Y no se pierde
